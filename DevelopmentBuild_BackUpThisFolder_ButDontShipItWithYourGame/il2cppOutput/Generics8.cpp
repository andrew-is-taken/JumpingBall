...
{
	{
		...
		L_0 = ((  KeyCollection_t57E7027B18F8890DCAC4C411739727D7248C1B95* (*) (Dictionary_2_tFA83D9B0331D5487A8CB52C61859A911DEB38393*, const RuntimeMethod*))il2cpp_codegen_get_method_pointer(il2cpp_rgctx_method(method->klass->rgctx_data, 39)))(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 39));
		return (RuntimeObject*)L_0;
	}
}
